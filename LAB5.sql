--bài 1a
create proc bai1_a @name nvarchar(20)
as
	begin
		print 'xin chào: ' + @name
	end
...
go
--bài 1b
create proc bai1_b @so1 int, @so2 int
as
	begin
		declare @tong int = 0;
		set @tong = @so1 + @so2 
...
go
--bài 1d
create proc bai1_d @a int, @b int
as
	begin
		while (@a != @b)
			begin
...
go
--bài 2a
create proc bai2_a @MaNV varchar(20)
as
	begin
...
create proc bai2_d @MaTP varchar(10)
as
begin
	select HONV, TENNV, TENPHG, NHANVIEN.MANV, THANNHAN.*
	from NHANVIEN
...
create proc bai2_e @MaNV varchar(10), @MaPB varchar(10)
as
begin
...
exec bai3_a '8','CNTT','008','2002-05-22'
--bài 3b
create proc bai3_b
	@MaPB int, @TenPB nvarchar(20),
	@MaTP varchar(10), @NgayNhanChuc date
...
exec bai3_c 'Bui', 'Duc', 'Danh', '129', '2002-05-22', 'Long An', 'Nam','25000', '004', '6'
exec bai3_c 'Nguyen', 'Van', 'A', '130', '2020-09-5', 'TP HCM', 'Nam','25000', '005', '9'
exec bai3_c 'Đang', 'Van', 'B', '018', '1954-02-11', 'Bình Định', 'Nam','25000', '004', '5'
